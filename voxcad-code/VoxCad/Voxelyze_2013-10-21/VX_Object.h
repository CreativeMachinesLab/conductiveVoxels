...
{
public:
	CVXC_Structure() {pData = NULL; muscleTypeArray = NULL; sensorTypeArray = NULL; ClearStructure();};
	CVXC_Structure(int xV, int yV, int zV) {pData = NULL; muscleTypeArray = NULL; sensorTypeArray = NULL; CreateStructure(xV, yV, zV);};
	...
	inline char& GetMyMuscleTypeArray(int Index) const {if (DataInit) return muscleTypeArray[Index]; else return (char&)defaultReturn;} //Gets the material index here (this should be the only place we access pData)
	inline char& GetMySensorTypeArray(int Index) const {if (DataInit) return sensorTypeArray[Index]; else return (char&)defaultReturn;} //Gets the material index here (this should be the only place we access pData)
	...
	inline void SetMuscleTypeArray(int Index, char Data){if (DataInit) muscleTypeArray[Index] = Data;} //sets the material index here
	inline void SetSensorTypeArray(int Index, char Data){if (DataInit) sensorTypeArray[Index] = Data;} //sets the material index here
...
protected:
	...
	char* muscleTypeArray;
	char* sensorTypeArray;
...
public:
	...
	inline char& GetMuscleTypeArray(int Index) const {return Structure.GetMyMuscleTypeArray(Index);} //Gets the material index here (this should be the only place we access pData)
	inline char& GetSensorTypeArray(int Index) const {return Structure.GetMySensorTypeArray(Index);} //Gets the material index here (this should be the only place we access pData)
