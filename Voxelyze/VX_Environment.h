...
public:
	...
	bool EvolvingNeuralNetworksCheck(void) {return EvolvingNeuralNetworks;} //!< Returns true if temperature variation is currently enabled.
	bool PhaseDrivenActuationCheck(void) {return PhaseDrivenActuation;} //!< Returns true if temperature variation is currently enabled.
	...
	void SetElectricityUpdatePeriod(vfloat _ElectricityUpdatePeriod) {ElectricityUpdatePeriod = ElectricityUpdatePeriod;} //!< Set the period at which temperature varies. @param[in] TempPeriodIn Desired temperature variation period in seconds.
	vfloat GetElectricityUpdatePeriod(void) {return ElectricityUpdatePeriod;} //!< Return current base temperature.
	void SetNeuralUpdatePeriod(vfloat _NeuralUpdatePeriod) {NeuralUpdatePeriod = NeuralUpdatePeriod;} //!< Set the period at which temperature varies. @param[in] TempPeriodIn Desired temperature variation period in seconds.
	vfloat GetNeuralUpdatePeriod(void) {return NeuralUpdatePeriod;} //!< Return current base temperature.
...
private:
	...
	bool EvolvingNeuralNetworks;
	bool PhaseDrivenActuation;
	vfloat TempBase, TempAmplitude, TempPeriod, ElectricityUpdatePeriod, NeuralUpdatePeriod; //degress celcius
