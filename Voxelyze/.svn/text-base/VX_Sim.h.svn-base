...
//	std::ofstream out;
	...
	inline int NumVox(void) const; //!< Returns the number of voxels in the simulation.
	...
	inline int NumBond(void) const; //!< Returns the number of bonds in the simulation.
